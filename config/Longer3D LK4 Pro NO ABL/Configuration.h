...
#define STRING_CONFIG_H_AUTHOR "(mrv96, LK4 Pro)" // Who made the changes.
 ...
 */
#define BAUDRATE 115200 //TODO: try if with 250000 everything works well
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_STATE     HIGH//LOW        // Pin state indicating that filament is NOT present.
  #define FIL_RUNOUT_PULLUP               // Use internal pullup for filament runout pins.
  //#define FIL_RUNOUT_PULLDOWN           // Use internal pulldown for filament runout pins.

  // Set one or more commands to execute on filament runout.
  // (After 'M412 H' Marlin will ask the host to handle the process.)
  #define FILAMENT_RUNOUT_SCRIPT "M600" // TODO: check if this works well, otherwise use "M25" to pause
...
#define PREHEAT_2_TEMP_BED    100//110
