 ...
 */
   ...
   */
  #define WATCH_BED_TEMP_PERIOD                60//90 // Seconds
  #define WATCH_BED_TEMP_INCREASE               2//1 // Degrees Celsius
#endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN HEATER_1_PIN        // Set a custom pin for the controller fan
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       /*660*/800        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  8//100
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  8//100
